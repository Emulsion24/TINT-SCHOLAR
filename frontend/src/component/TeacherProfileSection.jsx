...
const TeacherProfileSection = () => {
  const { teacher, uploadProfilePhoto } = useAuthStore();
  const [photo, setPhoto] = useState(null);
  const [profilePhoto, setProfilePhoto] = useState(teacher?.profilePhoto || "https://via.placeholder.com/150");
    ...
    >
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-gray-300">
            <span className="font-semibold text-teal-500">Employee.no: </span>
            {teacher.employeeId}
          </p>
          <p className="text-gray-300">
            <span className="font-semibold text-teal-500">Department: </span>
            {teacher.department}
          </p>
          <p className="text-gray-300">
