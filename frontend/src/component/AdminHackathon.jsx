...
const AdminHackathon = ({UserId}) => {
  const hackathons = useAuthStore((state) => state.hackathons);
  const fetchAdminHackathon = useAuthStore((state) => state.fetchAdminHackathon);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      await fetchAdminHackathon(UserId); // Fetch hackathons on component mount
  ...
  const handleUploadHackathon = async () => {
    ...
    try {
      ...
      await fetchAdminHackathon(UserId);
